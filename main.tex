...
%A solution of a hybrid system $\mathcal{H}$ is a map $\phi:dom \phi  \mapsto
%\mathbb{R}^n$ where $dom \phi$ is a hybrid time domain.  
%$\phi$ is called a hybrid arc and satisfies hybrid basic conditions of
%\cite{hybrid_2012}.
